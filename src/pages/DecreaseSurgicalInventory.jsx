...
function DecreaseSurgicalInventory() {
                        ...
                        <form class="w-full max-w-lg">
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                                    <h2 class="mb-10 mt-5 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-black">Decrease Surgical Inventory Amount</h2>
...
export default DecreaseSurgicalInventory
