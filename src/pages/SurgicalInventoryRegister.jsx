...
function SurgicalInventoryRegister() {
    ...
    const [type, setType] = useState("surgical");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response) {
                ...
                navigate("/surgicalInventories", { state: { wardID: location.state.wardID } });
            }
        }
        catch (error) {
            console.log(error);
                        ...
                        <form class="w-full max-w-lg">
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                                    <h2 class="mb-10 mt-5 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-black">Surgical Inventory Registration</h2>
...
export default SurgicalInventoryRegister
