...
function IncreaseSurgicalInventory() {
                        ...
                        <form class="w-full max-w-lg">
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                                    <h2 class="mb-10 mt-5 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-black">Increase Surgical Inventory Amount</h2>
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password">
                                        Surgical Inventory Name
                                    </label>
...
export default IncreaseSurgicalInventory
