  ...
  return (
    <div>
      ...
      <div class="flex items-center justify-between mb-6">
                <button onClick={(e) => { navigateMedicineRegister(e) }} class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ml-16" type="button">
                  Add Medicine
                </button>
              </div>
